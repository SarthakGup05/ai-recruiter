                        ...
                        <div className="flex flex-col gap-3 px-3 pb-3 max-h-[70vh] overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-border/50">
                            {column.candidates.length === 0 ? (
                                ...
                                column.candidates.map((candidate) => (
                                    <Card
                                        key={candidate.id}
                                        className="group cursor-grab active:cursor-grabbing rounded-xl border-border/50 bg-background shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md hover:border-primary/30 active:scale-[0.98]"
                                    >
                                        <CardContent className="p-3.5">
                                            ...
                                            <div className="flex items-start justify-between gap-3">
                                                ...
                                                {/* Hidden action menu icon that appears on hover */}
